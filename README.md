...
> **Sync Status**: Based on upstream `docker/metadata-action` v6.0.0; this fork releases at the same version number as the corresponding upstream release.
  ...
  docker:
    ...
    steps:
      ...
      -
        name: Docker meta
        id: meta
        uses: LiquidLogicLabs/git-action-docker-metadata@v6
        with:
          images: name/app
      -
